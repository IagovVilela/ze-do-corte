...
export function DashboardTelemetryScopeTabs({
  ...
  return (
    <div
      className="mt-4 flex flex-col gap-2 border-t border-[var(--bn-border)] pt-4"
      role="tablist"
      aria-label="Janela da telemetria por unidade"
    >
      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[var(--bn-muted)]">
        Janela da telemetria
      </p>
      <div className="flex flex-wrap gap-1.5 rounded-2xl border border-[var(--bn-border)] bg-[var(--bn-surface-lowest)] p-1">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active
                  ? "bg-[var(--bn-primary-container)]/15 text-[var(--bn-primary)] ring-1 ring-[var(--bn-primary)]/35"
