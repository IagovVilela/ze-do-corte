...
**Modelo de receita:** freemium + assinatura Pro.
...
- Billing SaaS Free + Pro (Asaas; só Pro é cobrado)  
...
**Próximo foco comercial:** freemium para tração (base Free + conversão Pro), piloto com salões, onboarding WhatsApp mais simples, e validar CAC/LTV. Cada site de salão leva CTA “Crie o site da sua barbearia — grátis”.
...
| Demo vitrine | https://barbernegon-production.up.railway.app/ze-do-corte |
